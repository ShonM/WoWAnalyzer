...
const config: Config = {
  ...
  description: (
    <>
      Welcome to the Guardian Druid analyzer! We hope you find these suggestions and statistics
      useful.
      <br />
      <br />
      ...
      <br />
      <br />
      If you have questions about playing Guardian check out the{' '}
      <a href="https://www.discord.gg/dreamgrove">Dreamgrove</a> Discord for an active community,
      and the{' '}
      <a href="https://www.wowhead.com/guide/classes/druid/guardian/overview-pve-tank">
        Guardian guide
      </a>{' '}
      on Wowhead is an excellent resource.
    </>
  ),
