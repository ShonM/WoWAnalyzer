...
const config: Config = {
  ...
  exampleReport: '/report/7tQjb4CxLGhdrknX/6-Hardmode+The+Assembly+of+Iron+-+Kill+(2:16)/Aluska',
  // Add spells to display separately on the timeline
  timeline: {
    separateCastBars: [[]],
  },
  // The current spec identifier. This is the only place (in code) that specifies which spec this parser is about.
  spec: SPECS.CLASSIC_SHAMAN_ENHANCEMENT,
  ...
  parser: () =>
    import('./CombatLogParser' /* webpackChunkName: "ClassicEnhancementShaman" */).then(
