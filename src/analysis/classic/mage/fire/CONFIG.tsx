...
const config: Config = {
  ...
  exampleReport:
    '/report/RkXqAzrW38NBj1La/4-Normal+Ignis+the+Furnace+Master+-+Kill+(2:46)/Akuramalicé',
  // Add spells to display separately on the timeline
  timeline: {
    separateCastBars: [[]],
  },
  // The current spec identifier. This is the only place (in code) that specifies which spec this parser is about.
  spec: SPECS.CLASSIC_MAGE_FIRE,
  ...
  parser: () =>
    import('./CombatLogParser' /* webpackChunkName: "ClassicFireMage" */).then(
